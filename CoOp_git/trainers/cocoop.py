...
class PromptLearner(nn.Module):
    ...
    def forward(self, im_features):
        ...
        #print("im_feature", im_features.shape)
        final_features = self.projector(im_features)
        #im_features = im_features.squeeze(1)
        #print("im_feature_o", im_features.shape)
        #print("final_feture", final_features.shape)
        final_features = final_features.squeeze(1)

        bias = self.meta_net(final_features)  # (batch, ctx_dim)
